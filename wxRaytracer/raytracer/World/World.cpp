...
/*
   ...
   double dil = 150.0;
   double z = (0.5)*(1+sin(((x/dil)*(x/dil)*(y/dil)*(y/dil)*(180/3.14159265359))*1.0));
   y = row;
   z = (z*255);
  // z = 255;
   paintArea->setPixel(x, y, (int)(mapped_color.r * z),
                             (int)(mapped_color.g * z),
                             (int)(mapped_color.b * z));
*/
