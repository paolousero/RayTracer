...
World::build(void) {
	...
	light_ptr1->set_direction(1, 5, 0);
	...
	Triangle* triangle_ptr2 = new Triangle(Point3D(6, 0, 6), Point3D(3, -2, -5), Point3D(-1, 0, -4)); 
	...
	Triangle* triangle_ptr3 = new Triangle(Point3D(8, 0, 8), Point3D(-6, -6, -5), Point3D(-1, 0, -4)); 
