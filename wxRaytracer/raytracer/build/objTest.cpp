...
World::build(void) {
	...
	*/
	...
	Triangle*	triangle_ptr2 = new Triangle(a,b,c); 
	triangle_ptr2->set_material(phong_ptr2);			
	...
	Triangle*	triangle_ptr3 = new Triangle(a,b,c); 
	triangle_ptr3->set_material(phong_ptr3);			
	...
	phong_ptr4->set_cd(brown);
	phong_ptr4->set_cds(brown);
	phong_ptr4->set_exp(exp);
	phong_ptr4->set_ks(ks);

	Sphere* sphere_ptr1 = new Sphere(Point3D(5,5,5), 5.0);
	sphere_ptr1->set_material(phong_ptr4);
	...
	*/
	...
	for(int x =0;x<faces.size();x++)
	{
		...
		phong_ptr->set_ka(ka);
		phong_ptr->set_kd(kd);
		phong_ptr->set_cd(lightblue);
		phong_ptr->set_cds(white);
		...
		Triangle*	triangle_ptr = new Triangle(faces[x][0],faces[x][1],faces[x][2]); 
		//Triangle*	triangle_ptr = new Triangle(a,b,c); 
		triangle_ptr->set_material(phong_ptr);			// light purple
	...
	*/
		...
		phong_ptr->set_cds(green);
		phong_ptr->set_exp(exp);
		phong_ptr->set_ks(ks);
		
	
	Sphere*	sphere_ptr= new Sphere(Point3D(0, -5, -200), 5); 
	...
	add_object(sphere_ptr);
		...
		phong_ptr2->set_exp(exp);
		phong_ptr2->set_ks(ks);
		Sphere*	sphere_ptr2= new Sphere(Point3D(5, 8, 0), 5); 
	...
	add_object(sphere_ptr2);
		...
		phong_ptr3->set_exp(exp);
		phong_ptr3->set_ks(ks);
			Sphere*	sphere_ptr3= new Sphere(Point3D(-8, 0, 0), 5); 
